...
/* Esta funcion calcula el maximo comun divisor de los numeros N1 y N2. */
{
   ...
   while ((N1 % I) || (N2 % I))
    /*El ciclo se matiene activo mientras (N1 % I) o (N2% I) sean distintos de cero. Cuando el resultado de la evaluacion sea 0, el ciclo se detiene ya que se habrá encontrado el maximo comun divisor. */
    I--;
    return I;
}
