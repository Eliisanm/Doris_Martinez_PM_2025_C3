...
/*Empresa textil.
El programa, al recibir como datos decisivos la categoria y antiguedad de un empleado, dtermina si el mismo reune las condiciones establecidad por la empresa para ocupar un nuevo cargo en una sucursal.
