...
/*Observa que siempre es necesario declarar el numero de columnas. Si no lo haces, el complicador marcará un error de sintaxis. */
...
/* La funcion Lectura se utiliza para leer un arreglo bidimensional. Observa que sólo se debe pasar como parámetro el número de filas ya que la matriz es cuadrada.*/
{
    int I, J;
    for (I=0; I<F; I++)
        for (J=0; J<F; J++)
