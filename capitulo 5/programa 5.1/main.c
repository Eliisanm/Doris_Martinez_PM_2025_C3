...
/*cuenta-numeros.
El programa, al recibir como datos un arreglo unididimensional de tipo entero y un numero entero, determina cuantas veces se encuentra el numero en el arreglo.*/
