...
/*Lluvias.
El programa permite calcular el promedio mensual de las lluvias caidas en tres regiones importantes del país. Determina cual es la region con mayor promedio de lluvia anual. */
