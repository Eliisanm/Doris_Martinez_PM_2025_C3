...
I, MAT, MAMAT y MEMAT: variables de tipo entero. CAL, SUM, MAPRO, MEPRO Y PRO: variables de tipo real.*/

void main(void)
{
int I, MAT, MAMAT, MEMAT; float SUM, PRO, CAL, MAPRO = 0.0, MEPRO = 11.0; printf("Ingrese la matrícula del primer alumno:\t");
scanf("%d", &MAT);
while (MAT)
{
SUM = 0; for (I = 1; I<= 5; I++)
{
printf("\tIngrese la calificación del alumno: ", I); scanf("%f", &CAL);
SUM += CAL;
